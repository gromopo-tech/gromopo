...
import BlurredShapegreen from "@/public/images/blurred-shape-green.svg";
...
export default function Features() {
  return (
    <section className="relative">
      <div
        className="pointer-events-none absolute left-1/2 top-0 -z-10 -mt-20 -transky-x-1/2"
        aria-hidden="true"
      >
        <Image
          className="max-w-none"
          src={BlurredShapegreen}
          width={760}
          height={668}
          alt="Blurred shape"
        />
      ...
      <div
        className="pointer-events-none absolute bottom-0 left-1/2 -z-10 -mb-80 -transky-x-[120%] opacity-50"
        aria-hidden="true"
      >
        <Image
          className="max-w-none"
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-sky-400/.25),transparent)1] md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-linear-to-r before:from-transparent before:to-sky-200/50 after:h-px after:w-8 after:bg-linear-to-l after:from-transparent after:to-sky-200/50">
              <span className="inline-flex bg-linear-to-r from-sky-500 to-sky-200 bg-clip-text text-transparent">
                Advanced Controls
              </span>
            </div>
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-green-200),var(--color-sky-200),var(--color-green-50),var(--color-sky-300),var(--color-green-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <h3 className="mb-1 font-nacelle text-[1rem] font-semibold text-green-200">
                Project Milestones
              </h3>
