  ...
  return (
    <>
      ...
      <div style={{ textAlign: "left" }}>
        ...
        <p>
          We are GroMoPo. These terms constitute a legally binding agreement made between you and GroMoPo, concerning your access to 
          and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all 
          of these terms. We will provide you with prior notice of any scheduled changes to the Services you are using.
        ...
        <p>
          You can contact us at support@gromopo.com.
        </p>
        <div
          className="MsoNormal"
